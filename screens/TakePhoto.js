...
export default function TakePhoto({navigation}) {
    ...
    <Container>
        ...
        :
            <Image source={{uri:takenPhoto?takenPhoto : null}} style={{flex:1}}/>
        }
        {takenPhoto === "" ?
            <Actions>
                <SliderContainer>
                ...
                <ButtonContainer>
                    ...
                    <ActionsContainer>
                        <TouchableOpacity onPress={onFlashModeChange} style={{marginRight: 30}}>
                            <Ionicons size={34} color="white" name={
                        ...
                        <TouchableOpacity onPress={onCameraSwitch}>
                            <Ionicons size={34} color="white" name={cameraType === Camera.Constants.Type.front? "camera-reverse":"camera"} />
                        </TouchableOpacity>
                    </ActionsContainer>
                </ButtonContainer>
            </Actions>
